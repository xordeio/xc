# Description: Install docker on Debian/Ubuntu
apt update; apt install -y curl gpg; curl -fsSL https://download.docker.com/linux/debian/gpg | gpg --yes --dearmor -o /usr/share/keyrings/docker-archive-keyring.gpg
